...
export const StyledDivHeading = styled.div`
  display: flex;
  flex-flow: column;
  align-items: center;
  padding: 8px;
...
export const StyledFooter = styled.div`
  ...
  bottom: 0px;
  height: 10vh;
  background-color: rgb(186, 165, 148);
`;
...
export const StyledMinorHeadingProfile = styled(StyledHeadingSection)`
  text-align: center;
  margin-top: -8px;
  font-weight: 300;
`;
...
export const StyledHeadingProfile = styled(StyledHeadingHome)`
  font-size: 16px;
`;
//Styled Inputs
...
export const StyledNavLink = styled(Link)`
  ...
  font-weight: 400;
  font-size: 12px;
  filter: ${(props) => (props.$active ? "invert(0.8)" : "")};
`;
